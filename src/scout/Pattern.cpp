...
#define PATTERNS_URL   "@mirror@scalasca_patterns-" SCALASCA_VERSION ".html#"
 ...
 **/
void Pattern::reg_cb(CallbackManagerMap&)
{
  init();
}
 ...
 **/
bool Pattern::skip_cnode(const pearl::Callpath& /* cnode */) const
{
  return false;
}
