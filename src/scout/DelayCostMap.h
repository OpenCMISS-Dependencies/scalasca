...
public:
    ...
    double getCosts(const pearl::Event& e) const;
    void   addCosts(const SynchpointInfoMap& sps, double scale);
    void   addCosts(const SynchpointInfoMap& sps, const ScaleMap& scales);
