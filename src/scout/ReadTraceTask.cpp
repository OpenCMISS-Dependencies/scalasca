 ...
 **/
class OpenTraceContainer : public pearl::Task
{
  public:
 ...
 **/
class ReadIdMappings : public pearl::Task
{
  public:
    /// @name Constructors & destructor
    /// @{
 ...
 **/
class ReadTraceData : public pearl::Task
{
  public:
    /// @name Constructors & destructor
    /// @{
 ...
 *  trace container files).
 **/
class CloseTraceContainer : public pearl::Task
{
  public:
    /// @name Constructors & destructor
    /// @{
   ...
   *  are fulfilled.
   **/
  class CheckTraceData : public pearl::Task
  {
    public:
      /// @name Constructors & destructor
      /// @{
 ...
 **/
bool OpenTraceContainer::execute()
{
...
bool ReadIdMappings::execute()
{
  ...
  return (NULL != mPrivateData.mIdMaps);
}
...
bool ReadTraceData::execute()
{
  ...
  return (NULL != mPrivateData.mTrace);
}
 ...
 *  @throw  pearl::FatalError  if the trace data contains inconsistent data
 **/
bool CloseTraceContainer::execute()
{
  #pragma omp master
  {
