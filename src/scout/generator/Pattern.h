...
class Pattern
{
  public:
    ...
    void set_staticinit(const std::string& code) { m_staticinit = code;  }
    ...
    std::string get_staticinit() const { return m_staticinit; }
    ...
    /* Adding callbacks */
    bool add_callback(const std::string& cbgroup, 
  ...
  private:
    ...
    std::map< std::string, std::vector<std::string> > 
      m_callbackgroups;      // callbackgroups |-> events 
    std::map< std::string, std::string > 
      m_callbacks;           // event |-> callback code
