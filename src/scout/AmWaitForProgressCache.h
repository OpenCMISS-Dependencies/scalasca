...
class AmWaitForProgressCache
{
    public:
        ...
        class Element
        {
            public:
                ...
                /// @}
                /// @nam Remote information interface
                /// #{
    ...
    private:
        ...
        // prohibit copying
        AmWaitForProgressCache(const AmWaitForProgressCache&);
        const AmWaitForProgressCache&
        operator=(const AmWaitForProgressCache&);

        // friend declarations (to access Element class)
        //friend class AmWaitForProgressRequest;
        //friend class AmWaitForProgressResponse;
};
} // namespace scout
