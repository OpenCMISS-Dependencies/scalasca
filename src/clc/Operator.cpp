...
void clc_max(amortization_data* in,
...
void clc_min(amortization_data* in,
             amortization_data* inout,
             int*               len,
             MPI_Datatype*)
{
...
void stat_rel_max(statistic_data* in,
...
void stat_rel_min(statistic_data* in,
                  statistic_data* inout,
                  int*            len,
                  MPI_Datatype*)
{
...
void stat_abs_max(statistic_data* in,
                  statistic_data* inout,
                  int*            len,
                  MPI_Datatype*)
{
...
void stat_abs_min(statistic_data* in,
                  statistic_data* inout,
                  int*            len,
                  MPI_Datatype*)
{
