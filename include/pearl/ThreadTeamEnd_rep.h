...
class PEARL_NOPAD_ATTR ThreadTeamEnd_rep : public Event_rep
{
  public:
    /// @name Constructors & destructor
    /// @{

    ThreadTeamEnd_rep(timestamp_t timestamp, uint32_t threadTeam );
    ThreadTeamEnd_rep(const GlobalDefs& defs, Buffer& buffer);
