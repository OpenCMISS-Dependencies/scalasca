...
class PEARL_NOPAD_ATTR ThreadJoin_rep : public Event_rep
{
  public:
    /// @name Constructors & destructor
    /// @{

    ThreadJoin_rep(timestamp_t timestamp, Paradigm paradigm);
    ThreadJoin_rep(const GlobalDefs& defs, Buffer& buffer);
